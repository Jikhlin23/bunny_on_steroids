        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mb-4 text-gray-300 max-w-md">
              A showcase of my academic journey, projects, and experiences throughout college.
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">Email: student@university.edu</li>
              <li className="text-gray-300">Location: University Campus</li>
              <li className="text-gray-300">Department: Computer Science</li>
            </ul>
          </div>
        </div>
