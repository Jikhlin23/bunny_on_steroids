...
import NewsletterSection from "@/components/ui/newsletter"; // ✅ Import this
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-12 pb-6">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8 text-navy-800">
            Featured Post
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <h3 className="text-3xl font-bold mb-4 text-navy-800">
                {blogPosts[2].title}
              </h3>
              <p className="text-navy-600 mb-4">{blogPosts[2].excerpt}</p>
              <div className="mb-6 text-gray-500">{blogPosts[2].date}</div>
      ...
      {/* Newsletter */}
      <NewsletterSection /> {/* ✅ Correct way to embed the form */}
      <Footer />
    </div>
  );
};
