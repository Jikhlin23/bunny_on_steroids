  ...
  const projects = [
    {
      ...
      description:
        "Developed a system to identify the most relevant paragraphs in a corpus based on a given question. Leveraged natural language processing techniques to extract and rank information efficiently, enhancing query-based information retrieval.",
      image:
    ...
    },
    {
      ...
      description:
        "Implemented Retrieval Augmented Generation using a large language model API to generate concise, contextually accurate responses. Integrated document retrieval and response generation for improved answer quality in question-answering systems.",
      image:
        "https://images.unsplash.com/photo-1677442135136-760c813028c4?auto=format&fit=crop&w=600&h=400",
    ...
    },
    {
      ...
      description:
        "Designed and implemented a Trie data structure for efficient query processing and a Linked List for seamless result retrieval. Optimized the system for fast and scalable handling of large query datasets.",
      image:
        "https://images.unsplash.com/photo-1580894732444-8ecded7900cd?auto=format&fit=crop&w=600&h=400",
    ...
    },
    {
      ...
      description:
        "Developed an embedded system that detects car crashes and automatically sends emergency notifications with location data.",
      image:
    ...
    },
    {
      ...
      description:
        "Created a machine learning model to predict equipment failures in industrial settings, reducing downtime and maintenance costs.",
      image:
    ...
    },
    {
      ...
      description:
        "Built a simulator for testing and analyzing various network protocols under different conditions and traffic loads.",
      image:
            ...
            <TabsContent value={activeTab} className="mt-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredProjects.map((project) => (
                  <Card
                    key={project.id}
                    className="overflow-hidden hover:scale-105 hover:shadow-lg transition-all duration-300 hover:border-3 border"
                  >
