  ...
  const featuredProjects = [
    {
      ...
      description:
        "Developed a system to identify the most relevant paragraphs in a corpus based on a given question using natural language processing techniques.",
      image:
    ...
    },
    {
      ...
      description:
        "Implemented RAG using a large language model API to generate concise, contextually accurate responses for question-answering systems.",
      image:
    ...
    },
    {
      ...
      description:
        "Designed and implemented efficient data structures for query processing and result retrieval, optimized for large datasets.",
      image:
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-in">
            ...
            <p className="text-lg text-foreground/80 mb-6">
              ...
              at IIT Kanpur with a CPI of 8.0/10. Passionate about technology
      ...
      <section className="container-section">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle mx-auto">
            A selection of important courses I've completed that have shaped my
            knowledge and skills.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {keyCourses.slice(0, 4).map((course) => (
            <div
              key={course.id}
