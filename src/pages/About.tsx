  ...
  const education = [
    {
      ...
      period: "2022 - Present",
      description:
        "Minor in Machine Learning, Systems, and Algorithms in the CSE department. Current GPA: 8.0/10.0",
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-navy-700 mb-4">
                ...
                undergraduate at IIT Kanpur with a CPI of 8.0/10. Passionate
